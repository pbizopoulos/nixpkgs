...
const (
	...
	SYS_CLEARENV                        = 0xC9  
	SYS___CLRENV                        = 0xC9  
	SYS___REGCOMP_STD                   = 0xEA  
	SYS_NL_LANGINFO                     = 0xFC  
	SYS_GETSYNTX                        = 0xFD  
	SYS_ISBLANK                         = 0xFE  
	SYS___ISBLNK                        = 0xFE  
	SYS_ISWALNUM                        = 0xFF  
	...
	SYS___LE_RECORD_DUMP                = 0xD73 
	SYS_FSTAT64                         = 0xD74 
	SYS_LSTAT64                         = 0xD75 
	SYS_STAT64                          = 0xD76 
	SYS___READDIR2_64                   = 0xD77 
	SYS___OPEN_STAT64                   = 0xD78 
	SYS_FTW64                           = 0xD79 
	SYS_NFTW64                          = 0xD7A 
	SYS_UTIME64                         = 0xD7B 
	SYS_UTIMES64                        = 0xD7C 
	SYS___GETIPC64                      = 0xD7D 
	SYS_MSGCTL64                        = 0xD7E 
	SYS_SEMCTL64                        = 0xD7F 
	SYS_SHMCTL64                        = 0xD80 
	SYS_MSGXRCV64                       = 0xD81 
	SYS___MGXR64                        = 0xD81 
	SYS_W_GETPSENT64                    = 0xD82 
	SYS_PTHREAD_COND_TIMEDWAIT64        = 0xD83 
	SYS_FTIME64                         = 0xD85 
	SYS_GETUTXENT64                     = 0xD86 
	SYS_GETUTXID64                      = 0xD87 
	SYS_GETUTXLINE64                    = 0xD88 
	SYS_PUTUTXLINE64                    = 0xD89 
	SYS_NEWLOCALE                       = 0xD8A 
	SYS_FREELOCALE                      = 0xD8B 
	SYS_USELOCALE                       = 0xD8C 
	SYS_DUPLOCALE                       = 0xD8D 
	SYS___CHATTR64                      = 0xD9C 
	SYS___LCHATTR64                     = 0xD9D 
	SYS___FCHATTR64                     = 0xD9E 
	SYS_____CHATTR64_A                  = 0xD9F 
	SYS_____LCHATTR64_A                 = 0xDA0 
	SYS___LE_CEEUSGD                    = 0xDA1 
	SYS___LE_IFAM_CON                   = 0xDA2 
	SYS___LE_IFAM_DSC                   = 0xDA3 
	SYS___LE_IFAM_GET                   = 0xDA4 
	SYS___LE_IFAM_QRY                   = 0xDA5 
	SYS_ALIGNED_ALLOC                   = 0xDA6 
	SYS_ACCEPT4                         = 0xDA7 
	SYS___ACCEPT4_A                     = 0xDA8 
	SYS_COPYFILERANGE                   = 0xDA9 
	SYS_GETLINE                         = 0xDAA 
	SYS___GETLINE_A                     = 0xDAB 
	SYS_DIRFD                           = 0xDAC 
	SYS_CLOCK_GETTIME                   = 0xDAD 
	SYS_DUP3                            = 0xDAE 
	SYS_EPOLL_CREATE                    = 0xDAF 
	SYS_EPOLL_CREATE1                   = 0xDB0 
	SYS_EPOLL_CTL                       = 0xDB1 
	SYS_EPOLL_WAIT                      = 0xDB2 
	SYS_EPOLL_PWAIT                     = 0xDB3 
	SYS_EVENTFD                         = 0xDB4 
	SYS_STATFS                          = 0xDB5 
	SYS___STATFS_A                      = 0xDB6 
	SYS_FSTATFS                         = 0xDB7 
	SYS_INOTIFY_INIT                    = 0xDB8 
	SYS_INOTIFY_INIT1                   = 0xDB9 
	SYS_INOTIFY_ADD_WATCH               = 0xDBA 
	SYS___INOTIFY_ADD_WATCH_A           = 0xDBB 
	SYS_INOTIFY_RM_WATCH                = 0xDBC 
	SYS_PIPE2                           = 0xDBD 
	SYS_PIVOT_ROOT                      = 0xDBE 
	SYS___PIVOT_ROOT_A                  = 0xDBF 
	SYS_PRCTL                           = 0xDC0 
	SYS_PRLIMIT                         = 0xDC1 
	SYS_SETHOSTNAME                     = 0xDC2 
	SYS___SETHOSTNAME_A                 = 0xDC3 
	SYS_SETRESUID                       = 0xDC4 
	SYS_SETRESGID                       = 0xDC5 
	SYS_PTHREAD_CONDATTR_GETCLOCK       = 0xDC6 
	SYS_FLOCK                           = 0xDC7 
	SYS_FGETXATTR                       = 0xDC8 
	SYS___FGETXATTR_A                   = 0xDC9 
	SYS_FLISTXATTR                      = 0xDCA 
	SYS___FLISTXATTR_A                  = 0xDCB 
	SYS_FREMOVEXATTR                    = 0xDCC 
	SYS___FREMOVEXATTR_A                = 0xDCD 
	SYS_FSETXATTR                       = 0xDCE 
	SYS___FSETXATTR_A                   = 0xDCF 
	SYS_GETXATTR                        = 0xDD0 
	SYS___GETXATTR_A                    = 0xDD1 
	SYS_LGETXATTR                       = 0xDD2 
	SYS___LGETXATTR_A                   = 0xDD3 
	SYS_LISTXATTR                       = 0xDD4 
	SYS___LISTXATTR_A                   = 0xDD5 
	SYS_LLISTXATTR                      = 0xDD6 
	SYS___LLISTXATTR_A                  = 0xDD7 
	SYS_LREMOVEXATTR                    = 0xDD8 
	SYS___LREMOVEXATTR_A                = 0xDD9 
	SYS_LSETXATTR                       = 0xDDA 
	SYS___LSETXATTR_A                   = 0xDDB 
	SYS_REMOVEXATTR                     = 0xDDC 
	SYS___REMOVEXATTR_A                 = 0xDDD 
	SYS_SETXATTR                        = 0xDDE 
	SYS___SETXATTR_A                    = 0xDDF 
	SYS_FDATASYNC                       = 0xDE0 
	SYS_SYNCFS                          = 0xDE1 
	SYS_FUTIMES                         = 0xDE2 
	SYS_FUTIMESAT                       = 0xDE3 
	SYS___FUTIMESAT_A                   = 0xDE4 
	SYS_LUTIMES                         = 0xDE5 
	SYS___LUTIMES_A                     = 0xDE6 
	SYS_INET_ATON                       = 0xDE7 
	SYS_GETRANDOM                       = 0xDE8 
	SYS_GETTID                          = 0xDE9 
	SYS_MEMFD_CREATE                    = 0xDEA 
	SYS___MEMFD_CREATE_A                = 0xDEB 
	SYS_FACCESSAT                       = 0xDEC 
	SYS___FACCESSAT_A                   = 0xDED 
	SYS_FCHMODAT                        = 0xDEE 
	SYS___FCHMODAT_A                    = 0xDEF 
	SYS_FCHOWNAT                        = 0xDF0 
	SYS___FCHOWNAT_A                    = 0xDF1 
	SYS_FSTATAT                         = 0xDF2 
	SYS___FSTATAT_A                     = 0xDF3 
	SYS_LINKAT                          = 0xDF4 
	SYS___LINKAT_A                      = 0xDF5 
	SYS_MKDIRAT                         = 0xDF6 
	SYS___MKDIRAT_A                     = 0xDF7 
	SYS_MKFIFOAT                        = 0xDF8 
	SYS___MKFIFOAT_A                    = 0xDF9 
	SYS_MKNODAT                         = 0xDFA 
	SYS___MKNODAT_A                     = 0xDFB 
	SYS_OPENAT                          = 0xDFC 
	SYS___OPENAT_A                      = 0xDFD 
	SYS_READLINKAT                      = 0xDFE 
	SYS___READLINKAT_A                  = 0xDFF 
	SYS_RENAMEAT                        = 0xE00 
	SYS___RENAMEAT_A                    = 0xE01 
	SYS_RENAMEAT2                       = 0xE02 
	SYS___RENAMEAT2_A                   = 0xE03 
	SYS_SYMLINKAT                       = 0xE04 
	SYS___SYMLINKAT_A                   = 0xE05 
	SYS_UNLINKAT                        = 0xE06 
	SYS___UNLINKAT_A                    = 0xE07 
	SYS_SYSINFO                         = 0xE08 
	SYS_WAIT4                           = 0xE0A 
	SYS_CLONE                           = 0xE0B 
	SYS_UNSHARE                         = 0xE0C 
	...
	SYS_CAPSET                          = 0xE0F 
	SYS_STRCHRNUL                       = 0xE10 
	SYS_PTHREAD_CONDATTR_SETCLOCK       = 0xE12 
	SYS_OPEN_BY_HANDLE_AT               = 0xE13 
	SYS___OPEN_BY_HANDLE_AT_A           = 0xE14 
	SYS___INET_ATON_A                   = 0xE15 
	SYS_MOUNT1                          = 0xE16 
	SYS___MOUNT1_A                      = 0xE17 
	SYS_UMOUNT1                         = 0xE18 
	SYS___UMOUNT1_A                     = 0xE19 
	SYS_UMOUNT2                         = 0xE1A 
	SYS___UMOUNT2_A                     = 0xE1B 
	SYS___PRCTL_A                       = 0xE1C 
	SYS_LOCALTIME_R2                    = 0xE1D 
	SYS___LOCALTIME_R2_A                = 0xE1E 
	SYS_OPENAT2                         = 0xE1F 
	SYS___OPENAT2_A                     = 0xE20 
	SYS___LE_CEEMICT                    = 0xE21 
	SYS_GETENTROPY                      = 0xE22 
	SYS_NANOSLEEP                       = 0xE23 
	SYS_UTIMENSAT                       = 0xE24 
	SYS___UTIMENSAT_A                   = 0xE25 
	SYS_ASPRINTF                        = 0xE26 
	SYS___ASPRINTF_A                    = 0xE27 
	SYS_VASPRINTF                       = 0xE28 
	SYS___VASPRINTF_A                   = 0xE29 
	SYS_DPRINTF                         = 0xE2A 
	SYS___DPRINTF_A                     = 0xE2B 
	SYS_GETOPT_LONG                     = 0xE2C 
	SYS___GETOPT_LONG_A                 = 0xE2D 
	SYS_PSIGNAL                         = 0xE2E 
	SYS___PSIGNAL_A                     = 0xE2F 
	SYS_PSIGNAL_UNLOCKED                = 0xE30 
	SYS___PSIGNAL_UNLOCKED_A            = 0xE31 
	SYS_FSTATAT_O                       = 0xE32 
	SYS___FSTATAT_O_A                   = 0xE33 
	SYS_FSTATAT64                       = 0xE34 
	SYS___FSTATAT64_A                   = 0xE35 
	SYS___CHATTRAT                      = 0xE36 
	SYS_____CHATTRAT_A                  = 0xE37 
	SYS___CHATTRAT64                    = 0xE38 
	SYS_____CHATTRAT64_A                = 0xE39 
	SYS_MADVISE                         = 0xE3A 
	SYS___AUTHENTICATE                  = 0xE3B 
)
