defmodule PhoenixApp.Accounts.User do
  ...
  defp validate_username(changeset, opts) do
    ...
    |> validate_format(:username, ~r/^[a-z0-9-]+$/,
      message: "must be a valid slug (only lowercase letters, numbers and hyphens)"
    )
  ...
  defp maybe_validate_unique_username(changeset, opts) do
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:username, PhoenixApp.Repo)
  ...
  """
  def valid_password?(%PhoenixApp.Accounts.User{hashed_password: hashed_password}, password)
