...
nix run --impure github:numtide/nix-gl-host -- nix run <URL>#<package>	# run <package> on non-NixOS with host graphics drivers, export NIXPKGS_ALLOW_UNFREE=1 if needed
